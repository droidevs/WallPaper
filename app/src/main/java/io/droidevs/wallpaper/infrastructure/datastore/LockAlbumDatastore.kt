...
class LockAlbumDatastore (
    ...
    val albumDao: AlbumDao,
     ...
     val albumKey: Preferences.Key<Long> = longPreferencesKey("lock_album_id")
    override suspend fun setLockAlbum(album: AlbumEntity) {
        dataStore.edit {
            it[albumKey] = album.id
        }
    }

    override suspend fun retrieveLockAlbum(): Flow<AlbumEntity> {
